<!-- BEGIN: MAIN -->
    <div class="row-fluid">
      <div class="span12">
        ...
        <h3>{PHP.L.Main}:</h3>
        <div class="alert alert-info">{PHP.L.plu_maxwasreached} {STATISTICS_MAX_DATE}, {STATISTICS_MAX_HITS} {PHP.L.plu_pagesdisplayedthisday}</div>
        <table class="table table-striped">
          <tr>
            <td>{PHP.L.plu_totalpagessince} {STATISTICS_SINCE}</td>
            <td class="textright">{STATISTICS_TOTALPAGES}</td>
          </tr>
          <tr>
      ...
      <div class="span6">
        ...
        <table class="table table-striped">
          <tr>
            ...
            <td class="textright">{STATISTICS_TOTALPMSENT}</td>
          </tr>
          <tr>
      ...
      <div class="span6">
        ...
        <table class="table table-striped">
          <tr>
            ...
            <td class="textright">{STATISTICS_TOTALDBVIEWS}</td>
          </tr>
          <tr>
      ...
      <div class="span6">
        ...
        <table class="table table-striped">
          <tr>
            ...
            <td class="textright">{STATISTICS_TOTALDBRATINGS}</td>
          </tr>
          <tr>
      ...
      <div class="span6">
        ...
        <table class="table table-striped">
          <tr>
            ...
            <td class="textright">{STATISTICS_TOTALDBFILES}</td>
          </tr>
          <tr>
    ...
    <!-- BEGIN: IS_USER -->
          <tr>
            ...
            <td class="textright">{STATISTICS_USER_POSTSCOUNT}</td>
          </tr>
          <tr>
      ...
      <div class="span6">
        ...
        <table class="table table-striped">
          <tr>
            ...
            <td class="coltop"><a href="{STATISTICS_PLU_URL}">{PHP.cot_img_down}</a> {PHP.L.Country}</td>
            <td class="coltop"><a href="{STATISTICS_SORT_BY_USERCOUNT}" rel="nofollow">{PHP.cot_img_down}</a> {PHP.L.Users}</td>
          </tr>
    <!-- BEGIN: ROW_COUNTRY -->
          <tr>
    ...
    <!-- END: ROW_COUNTRY -->
          <tr>
            <td class="textleft"><img src="images/flags/f-00.png" alt="" /></td>
            <td>{PHP.L.plu_unknown}</td>
            <td class="textright">{STATISTICS_UNKNOWN_COUNT}</td>
          </tr>
          <tr>
            <td colspan="2" class="textleft">{PHP.L.Total}:</td>
